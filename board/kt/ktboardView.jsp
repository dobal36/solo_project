...
<script>
	function ktdelCheck(){
		if(confirm("삭제하시겠습니까?")){
			location.href = "/myapp/board/kt/ktboardDel?no=${vo.no}";
		}
	}
	$(function(){
		function replyListAll(){
			var url = "/myapp/reply/ktlist";
			var params = "no=${vo.no}";
			$.ajax({
				url:url,
				data:params,
...
<div class="boardcontainer">
	...
	<div id="edit">
		<c:if test="${logNick==vo.nickname}">
			<a href="/myapp/board/kt/ktboardEdit?no=${vo.no}">수정</a>
			<a href="javascript:ktdelCheck()">삭제</a>
		</c:if>
	</div>
	<div id="replyList">
