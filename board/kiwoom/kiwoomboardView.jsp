...
<script>
	function kiwoomdelCheck(){
		if(confirm("삭제하시겠습니까?")){
			location.href = "/myapp/board/kiwoom/kiwoomboardDel?no=${vo.no}";
		}
	}
	$(function(){
		function replyListAll(){
			var url = "/myapp/reply/kiwoomlist";
			var params = "no=${vo.no}";
			$.ajax({
				url:url,
				data:params,
        ...
        $(document).on('submit','#replyList form',function(){
            ...
            let url2 = '/myapp/reply/kiwoomeditOk';
            $.ajax({
                url : url2,
                data : params2,
                type : 'POST',
...
<div class="boardcontainer">
	...
	<div id="edit">
		<c:if test="${logNick==vo.nickname}">
			<a href="/myapp/board/kiwoom/kiwoomboardEdit?no=${vo.no}">수정</a>
			<a href="javascript:kiwoomdelCheck()">삭제</a>
		</c:if>
	</div>
	<div id="replyList">
