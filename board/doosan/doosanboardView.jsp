...
<script>
	function doosandelCheck(){
		if(confirm("삭제하시겠습니까?")){
			location.href = "/myapp/board/doosan/doosanboardDel?no=${vo.no}";
		}
	}
	$(function(){
		function replyListAll(){
			var url = "/myapp/reply/doosanlist";
			var params = "no=${vo.no}";
			$.ajax({
				url:url,
				data:params,
        ...
        $(document).on('submit','#replyList form',function(){
            ...
            let url2 = '/myapp/reply/doosaneditOk';
            $.ajax({
                url : url2,
                data : params2,
                type : 'POST',
...
<div class="boardcontainer">
	...
	<div id="edit">
		<c:if test="${logNick==vo.nickname}">
			<a href="/myapp/board/doosan/doosanboardEdit?no=${vo.no}">수정</a>
			<a href="javascript:doosandelCheck()">삭제</a>
		</c:if>
	</div>
	<div id="replyList">
