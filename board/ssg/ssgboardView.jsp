...
<script>
	function ssgdelCheck(){
		if(confirm("삭제하시겠습니까?")){
			location.href = "/myapp/board/ssg/ssgboardDel?no=${vo.no}";
		}
	}
	$(function(){
		function replyListAll(){
			var url = "/myapp/reply/ssglist";
			var params = "no=${vo.no}";
			$.ajax({
				url:url,
				data:params,
        ...
        $(document).on('submit','#replyList form',function(){
            ...
            let url2 = '/myapp/reply/ssgeditOk';
            $.ajax({
                url : url2,
                data : params2,
                type : 'POST',
...
<div class="boardcontainer">
	...
	<div id="edit">
		<c:if test="${logNick==vo.nickname}">
			<a href="/myapp/board/ssg/ssgboardEdit?no=${vo.no}">수정</a>
			<a href="javascript:ssgdelCheck()">삭제</a>
		</c:if>
	</div>
	<div id="replyList">
